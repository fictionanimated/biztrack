...
export const initialIncomeSources: IncomeSource[] = [
  {
    ...
    name: "Web Design",
    gigs: [
      { id: "g1", name: "Acme Corp Redesign", date: "2023-01-15", messages: 125, analytics: generateAnalytics(new Date("2024-04-01"), 60, 500, 40, 5) },
      { id: "g2", name: "Startup Landing Page", date: "2023-01-25", messages: 52, analytics: generateAnalytics(new Date("2024-04-01"), 60, 300, 20, 2) },
      { id: "g3", name: "E-commerce Site for 'ShopEasy'", date: "2023-02-05", messages: 210, analytics: generateAnalytics(new Date("2024-04-01"), 60, 800, 60, 8) },
    ],
  ...
  },
  {
    id: "2",
    name: "Consulting",
    gigs: [{ id: "g4", name: "Q1 Strategy Session", date: "2023-01-20", messages: 30, analytics: generateAnalytics(new Date("2024-04-01"), 60, 150, 10, 1) }],
  ...
  },
  {
    ...
    name: "Logo Design",
    gigs: [
      { id: "g5", name: "Brand Identity for 'Innovate'", date: "2023-02-01", messages: 15, analytics: generateAnalytics(new Date("2024-04-01"), 60, 200, 15, 3) },
    ],
    dataPoints: [],
  },
  {
    id: "4",
    name: "SEO Services",
    gigs: [{ id: "g6", name: "Monthly SEO Retainer", date: "2023-02-10", messages: 88, analytics: generateAnalytics(new Date("2024-04-01"), 60, 400, 25, 4) }],
